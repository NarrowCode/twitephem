...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(argv, "hdvfb:e:s",["force","del","delhist","view","begin=","end=","silent"])
    except getopt.GetoptError:
        print("twitephem.py [-hdvfbes]")
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print("twitephem.py [-hdvfbes]")
            ...
            print("     -d:                 Delete")
            print("     -dh:                Delete and store history")
            print("     -v:                 View tweets")
